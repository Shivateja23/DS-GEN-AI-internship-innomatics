...
pytesseract.pytesseract.tesseract_cmd = r"C:\Program Files (x86)\tesseract-ocr-setup-3.05.01.exe"

# Initialize Google Generative AI with API Key
GEMINI_API_KEY = 'AIzaSyB-SmzBuzrAq0T1j2knDFetYBrqpINWQcE'  # Replace with your valid API key
...
# Main Title
st.markdown('<div class="main-title"> 👁️‍🗨️SmartSight AI 👁️‍🗨️</div>', unsafe_allow_html=True)
...
# Sidebar Features
st.sidebar.image(
    r"B:\GENAI-INTERN\GENAI_PROJECTS\vision@! ai.jpg",
    width=250
)
